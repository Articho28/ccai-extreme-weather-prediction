...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    recognitionClickListener = view -> {
      String query = recognitionTextView.getText().toString();
      startDiseaseDetailActivity(query, query, recognitionValueTextView.getText().toString());
    };

    recognition1ClickListener = view -> {
      String query = recognition1TextView.getText().toString();
      startDiseaseDetailActivity(query, query, recognition1ValueTextView.getText().toString());
    };

    recognition2ClickListener = view -> {
      String query = recognition2TextView.getText().toString();
      startDiseaseDetailActivity(query, query, recognition2ValueTextView.getText().toString());
    };
  ...
  protected void showResultsInBottomSheet(List<Recognition> results) {
    if (results != null && results.size() >= 3) {
      ...
      if (recognition != null) {
//        String titlePridiction = recognition.getTitle();
        if (recognition.getTitle() != null) {
//          if(titlePridiction.contains("__")){
//            titlePridiction.split()
//          }
